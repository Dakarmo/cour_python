...
# def main():
#     titanic = TitanicStatistique('titanic.csv')
#     choix = ''
#     def suite():
#         choice = input("Voulez vous poursuivre ou quitter ? O/N : ")
#         if choice =="oui" or choice == 'o' or  choice == 'O':
#             main()
#         elif choice == "nom" or choice == 'n' or  choice == 'N':
#            exit
...
#             print("Merci bien lire et suivre les instructions.")    
